...
(define-public (add-proof
    ...
    (let
        ...
        (asserts! (< block-height (get expiry-height identity)) ERR-EXPIRED)
...
(define-public (verify-identity
    ...
    (let
        ...
        (asserts! (< block-height (get expiry-height proof)) ERR-EXPIRED)
    ...
    (let
        ...
        (map-set Identities
            ...
            (merge identity {
                ...
                revocation-height: (some block-height)
            }))
...
(define-read-only (is-identity-valid
    ...
    (let ((identity (unwrap! (map-get? Identities {identity-hash: identity-hash}) false)))
        (and
            ...
            (< block-height (get expiry-height identity))
